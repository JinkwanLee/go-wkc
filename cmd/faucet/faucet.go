...
import (
	...
	"github.com/JinkwanLee/go-wkc/cmd/utils"
	...
	"github.com/JinkwanLee/go-wkc/ethclient"
...
func (f *faucet) apiHandler(w http.ResponseWriter, r *http.Request) {
	...
	for {
		...
		default:
			//lint:ignore ST1005 This error is to be displayed in the browser
			err = errors.New("Something funky happened, please open an issue at https://github.com/JinkwanLee/go-wkc/issues")
		}
		if err != nil {
			if err = sendError(wsconn, err); err != nil {
