...
```shell
go get github.com/JinkwanLee/go-wkc/cmd/checkpoint-admin
```
...
*CHECKPOINT_HASH is obtained based on this [calculation method](https://github.com/JinkwanLee/go-wkc/blob/master/params/config.go#L251).*
